        ...
        <div className="max-w-2xl mx-auto">
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-slate-900">
              {language === 'ko' ? '예측' : 'Prediction'}
            </h2>
            <p className="text-slate-600 mt-1">
              {language === 'ko'
                ? 'What-If 시뮬레이션 · 공정 변수 조절 시 예상 수율·전력·생산량 확인'
                : 'What-If simulation · Adjust process variables to see expected yield, power, and production'}
            </p>
          </div>
