...
import ProcessModel2D_v2 from '@/components/ProcessModel2D_v2';
...
export default function ProcessModel2Page() {
      ...
      <main className="pl-64 pr-80 pt-16 min-h-screen">
        <div className="p-6">
          <h1 className="text-2xl font-bold text-slate-900 mb-1">
            {language === 'ko' ? '공정 실시간 모델(2)' : 'Process Real-time Model (2)'}
          </h1>
          <p className="text-slate-600 text-sm mb-6">
            {language === 'ko'
              ? '왼쪽에서 오른쪽으로 흐르는 공정 흐름. LOT이 라인을 따라 이동합니다. (레일 스타일 v2)'
              : 'Process flow from left to right. LOTs move along the line. (Rail style v2)'}
          </p>
          ...
          {loading ? (
            ...
            <div className="flex flex-col gap-3">
              <ProcessModel2D_v2 lots={lots} lotProgress={lotProgress} language={language} />
